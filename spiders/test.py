...
class Myspider(scrapy.Spider):
    name = "test"
    # location_list = ['https://www.movoto.com/london-ca/', 'https://www.movoto.com/sidney-oh/', 'https://www.movoto.com/boston-ma/', '']
    headers = {
        'user-agent': 'Mozilla/5.0 (iPad; CPU OS 11_0 like Mac OS X) AppleWebKit/604.1.34 (KHTML, like Gecko) Version/11.0 Mobile/15A5341f Safari/604.1'
    }

    def start_requests(self):
        urls = ['https://www.movoto.com/san-francisco-ca/single-family/bed-5-0/@37.77493,-122.419416/',
                'https://www.movoto.com/london-ca/',
